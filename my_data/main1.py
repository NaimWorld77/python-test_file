...
# Dataset Handling
file_path = r'D:\first_project_smart_meteorology\combined_dataset.nc'
...
for time_index in range(len(time_data)):
    ...
    # Visualization Process (moved inside the loop)
    ...
    plt.close(fig)  # Ensure that the figure is closed after saving to free up memory
